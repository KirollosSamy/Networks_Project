...
std::string FrameDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_Header: return ulong2string(pp->getHeader());
        ...
        case FIELD_AckNum: return ulong2string(pp->getAckNum());
        default: return "";
    }
}
...
void FrameDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_Header: pp->setHeader(string2ulong(value)); break;
        ...
        case FIELD_AckNum: pp->setAckNum(string2ulong(value)); break;
...
omnetpp::cValue FrameDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_Header: return (omnetpp::intval_t)(pp->getHeader());
        ...
        case FIELD_AckNum: return (omnetpp::intval_t)(pp->getAckNum());
...
void FrameDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_Header: pp->setHeader(omnetpp::checked_int_cast<unsigned int>(value.intValue())); break;
        ...
        case FIELD_AckNum: pp->setAckNum(omnetpp::checked_int_cast<unsigned int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Frame_Base'", field);
    }
}
